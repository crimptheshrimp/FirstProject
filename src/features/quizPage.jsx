    ...
    <div id="quizContainer">
        {quizComplete ? (
            <div id="quizCompleteMessage">
                <h1>Quiz complete! Your score is {score} out of {questionNum}.</h1>
                <img src={pictureRandomiser()} alt="celebrity pop singer" className='img' id="finalImg"/>
            </div>
        ) : (
            <>
                <h1 id="questionNum">{questionNum}.</h1>
                <h1 id="currentQuestion"> {currentQ}</h1>
